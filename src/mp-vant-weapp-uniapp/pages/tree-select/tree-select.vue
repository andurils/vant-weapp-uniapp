<template>
	<view class="app">
		<wrap title="单选模式">
			<van-tree-select :items="items" :main-active-index="mainActiveIndex" :active-id="activeId" @clickItem="onClickItem" @clickNav="onClickNav"></van-tree-select>
		</wrap>
		...
		<wrap title="自定义内容">
			<van-tree-select
				:items="[{ text: '分组 1', info: 20 }, { text: '分组 2' }]"
				height="55vw"
