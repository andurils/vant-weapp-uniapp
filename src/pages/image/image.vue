	...
	<view class="app bg-white">
		<wrap title="基础用法">
			...
			<van-row gutter="20">
				...
				<van-col span="8">
					<view class="wrap-flex-col wrap-col-center">
		...
		<wrap title="长按图片显示识别小程序码菜单">
			...
			<van-row gutter="20">
				<van-col span="8">
					<view class="wrap-flex-col wrap-col-center">
						<van-image show-menu-by-longpress radius="10" width="100" height="100" :src="src"
							@load="onload" />
		...
		<wrap title="加载失败提示">
			...
			<van-row gutter="20">
				...
				<van-col span="8">
					<van-image width="100%" height="27vw" src="undefinedpath" use-error-slot @error="onerror"><text
							slot="error">加载失败</text></van-image>
					<view class="img-text">自定义提示</view>
				</van-col>
			</van-row>
		</wrap>
		<wrap title="自定义样式">
			...
			<van-row gutter="20">
				<van-col span="8">
					<van-image width="100" height="100" custom-class="cus-root" image-class="cus-image"
						:src="sampleImgPath" />
				</van-col>
			</van-row>
		</wrap>
		...
		<wrap title="懒加载">
			<gap height="24"></gap>
			<van-image width="100" height="100" lazy-load src="https://img.yzcdn.cn/vant/cat.jpeg" @load="onLazyLoad" />
		</wrap>
...
<script>
	export default {
		...
		methods: {
			...
			onLazyLoad(event) {
				console.log('LazyLoad 图片加载完毕时触发', event);
			},
		}
	};
</script>
